...
PATTERNS = {
    ...
    "INLINE_NAVIGATION_CONFLICT": "Встроенный материал не поддерживает обещанный отдельный переход",
    "ABSENCE_OF_EVIDENCE_ROUTE": "Маршрут сверки не учитывает отсутствие относящихся сведений",
    "INLINE_SCOPE_SPILL": "Встраивание целой карточки опережает учебный маршрут",
    "INDEPENDENT_METHOD_RECIPE": "Самостоятельную проверку предваряет готовый метод и основание",
    "CHOICE_VS_WORDING": "Собственный выбор смешивается с новизной формулировки",
    "LIVE_OUTPUT_COMPLETION": "Конец практики зависит от случайного качества первой генерации",
    "NAVIGATION_TARGET": "Указатель возврата не совпадает с фактическим местом работы",
    "RECOVERY_DISCLOSURE": "Повторная попытка раскрывает новое назначение или ограничивающую справку до собственного действия",
    "RECOVERY_ELIGIBILITY": "Условия новой попытки не охватывают все неподтверждённые случаи",
    "ASSET_INTEGRITY": "Повреждён обязательный материал одной из учебных веток",
