...
**Current Wave 0 readiness:** `NOT READY / BLOCKED FOR FIRST HUMAN SESSION` по baseline от 16.09.2026.
...
- [`readiness/wave0-readiness-2026-09-16.md`](readiness/wave0-readiness-2026-09-16.md) — **текущий** readiness record; verdict `NOT READY / BLOCKED FOR FIRST HUMAN SESSION`.
...
- доказанная эквивалентность private Stepik staging выбранному актуальному `main` SHA;
