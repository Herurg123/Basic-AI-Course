...
Перед работой ИИ-агенты и специализированные чаты должны ознакомиться с bootstrap-инструкцией, затем с `AGENTS.md`, актуальной инструкцией проекта, действующим манифестом и относящимися к задаче утверждёнными документами непосредственно в `main`.
