...
В `main` уже утверждены и размещены:

- структура репозитория и workflow;
- манифест курса v1.2;
- инструкция проекта v1.1;
- карта компетенций v1.1.

Текущий PR обновляет инструкцию проекта до v1.2 и автоматизирует запуск критика и merge при положительном заключении.
