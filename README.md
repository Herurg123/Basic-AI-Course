...
Следующий ограниченный этап после утверждения Матрицы покрытия — подготовить проектные карточки всех 21 уроков по стандарту и шаблону, не переходя автоматически к массовому производству ученических текстов, тестов, медиа и Stepik-экранов. Публичный выпуск курса по-прежнему требует предусмотренных приемочных проверок сервисов и тестирования на новичках.
