...
- стандарт сценария урока v1.0 и `lesson-template.md`.

Следующие ключевые архитектурные документы разрабатываются и добавляются отдельными Pull Request по мере утверждения. После стандарта сценария урока проект может переходить к сверке общей архитектуры и черновой Матрице покрытия, не начиная массовое производство уроков до соответствующего этапа.
