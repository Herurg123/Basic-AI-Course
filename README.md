...
После утверждения production vertical slice следующий разрешённый отдельный gate — **пилот M00–M01 на 3–5 настоящих новичках**. M02–M08 production, массовое производство остальных уроков, финальная Stepik-разметка, бета и публичный выпуск до результатов этого пилота не начинаются.
