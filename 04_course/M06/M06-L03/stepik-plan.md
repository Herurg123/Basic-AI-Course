...
- This is supported level-2 work, so reminding the four statuses is allowed.
- Do not supply a ready status or next action for either card before learner choice.
- No real high-stakes diagnosis/action.
- Second AI agreement does not increase evidence quality.
- `данных недостаточно` means do not apply the substantial conclusion as confirmed.

**Quiz:** optional supplement only.  
**Screenshots/uploads:** not required.  
**PRIMARY/BACKUP:** optional; no AI model serves as external ground by itself.
