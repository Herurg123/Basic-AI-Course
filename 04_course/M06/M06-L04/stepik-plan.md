...
| 4 | post-action C01 | Only after E01: in Stepik describe substantial, observable support of original answer (or `не установлено`), chosen ground, actual evidence/calculation/missing data, comparison, status, next action. No hidden-process guessing | free-answer Stepik + local trace | `M06-L04-C01` | CHECK |
